...
function validateMobileNo(mobNo)
{
	...
	{
		alert("Enter numeric value in the Mobile No. Field.");
		return false; 
	}

	if (y.length == 0)
	{
		alert("Mobile No. is required, please enter your 10 digits Mobile No. in the Mobile No. Field.");
		return false; 
	}

	if (y.length > 0 && y.length < 10)
	{
		alert("You have entered an incorrect Mobile No., please enter your 10 digits Mobile No. in the Mobile No. Field.");
		return false; 
	}
	
	if (y.length > 10)
	{
		alert("Enter only 10 digits in the Mobile No. Field.");
		return false; 
	}
	
	var fDigit = y.charAt(0);
	
	if (parseInt(fDigit) <= 6)
	{
